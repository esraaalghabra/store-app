                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> الاقسام الرئيسية</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tbody>
                                                @isset($mainCategories)
                                                    @foreach($mainCategories as $mainCategory)
                                                        <tr>
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$mainCategory -> photo}}" alt="..."></td>
                                                            <td>{{$mainCategory -> name}}</td>
                                                            <td>{{$mainCategory -> details}}</td>
                                                            <td>{{$mainCategory -> subCategories->count()}}</td>
                                                            <td>{{$mainCategory -> products->count()}}</td>
                                                            <td>{{$mainCategory -> getActive()}}</td>
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$mainCategory -> photo_first}}" alt="..."></td>
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$mainCategory -> photo_second}}" alt="..."></td>
                                                            <td>
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <a href="{{route('admin.maincategories.show_vendors',$mainCategory->id)}}" class="btn btn-outline-success btn-min-width box-shadow-3 mr-1 mb-1">عرض المتاجر</a>
                                                                    ...
                                                                    <a href="{{route('admin.maincategories.status',$mainCategory -> id)}}" class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">
                                                                        @if($mainCategory -> active == 0)تفعيل@elseالغاء تفعيل@endif
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
