                                        ...
                                        <table class="table display nowrap table-striped table-bordered scroll-horizontal">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th>المتجر </th>
                                                    <th>الحالة</th>
                                                    <th>صورة المنتج الإضافية الأولى </th>
                                                    <th>صورة المنتج الإضافية الثانية </th>
                                                    <th>الإجراءات </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @isset($products)
                                                    @foreach($products as $product)
                                                        <tr>
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$product -> photo}}" alt="..."></td>
                                                            <td>{{$product -> name}}</td>
                                                            <td>{{$product -> price}}</td>
                                                            <td>{{$product -> size}}</td>
                                                            ...
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$product -> photo_first}}" alt="..."></td>
                                                            <td> <img style="width: 150px; height: 100px;" src="{{$product -> photo_second}}" alt="..."></td>
                                                            <td>
