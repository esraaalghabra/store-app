                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="name" id="name" type="text" value="{{$vendor -> name}}" class="form-control" placeholder="  ">
                                                            @error("name")
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input name="active" id="active" type="checkbox" value="1"  class="switchery" data-color="success"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="details" id="details" type="text" value="{{$vendor -> details}}" placeholder="" class="form-control"  >
                                                            @error("details")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                                    ...
                                                                    @if($mainCategories && $mainCategories -> count() > 0)
                                                                        @foreach($mainCategories as $mainCategory)
                                                                            <option value="{{$mainCategory -> id }}"
                                                                                    @if($vendor -> main_category_id == $mainCategory -> id  )  selected @endif>{{$mainCategory -> name}}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                                    ...
                                                                    @if($subCategories && $subCategories -> count() > 0)
                                                                        @foreach($subCategories as $subCategory)
                                                                            <option value="{{$subCategory -> id }}"
                                                                                    @if($vendor -> sub_category_id == $subCategory -> id  )  selected @endif>{{$subCategory -> name}}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="address" id="pac-input" type="text" value="{{$vendor -> address}}" class="form-control" placeholder="">
                                                            @error("address")
                                                            <span class="text-danger"> {{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="mobile" id="mobile" type="number" value="{{$vendor -> mobile}}" class="form-control" placeholder="">
                                                            @error("mobile")
                                                                <span class="text-danger"> {{$message}}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="email" id="email" type="text" value="{{$vendor -> email}}" class="form-control" placeholder="" >
                                                            @error("email")
                                                            <span class="text-danger"> {{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="text-center">
                                                                <img src="{{$vendor  -> photo}}" class="ri-rounded-corner height-250" alt="صورة القسم">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="text-center">
                                                                <img src="{{$vendor  -> photo_first}}" class="ri-rounded-corner height-250" alt="صورة القسم">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label> صوره المتجر الإضافية الثانية </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="text-center">
                                                                <img src="{{$vendor  -> photo_second}}" class="ri-rounded-corner height-250" alt="صورة القسم">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
