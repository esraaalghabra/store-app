                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">متاجر قسم   {{$subCategory->name}}  </li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            @if(isset($subCategory->vendors) && $subCategory->vendors->count()>0)
                                                @foreach($subCategory->vendors as $index=> $vendor)
                                                                ...
                                                                <div class="col">
                                                                    <div class="collapse multi-collapse" id="vendor{{$index}}">
                                                                        ...
                                                                        <div class="card-body box-shadow-1 mr-3 mb-3">
                                                                            ...
                                                                            <h3 >قسم : {{$vendor->subCategory->name}}</h3>
