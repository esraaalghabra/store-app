...
<html class="loading" lang="en" data-textdirection="rtl">
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('assets/icon/products/favicon.ico')}}" />
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/fonts/meteocons/products_styles.css')}}">
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/fonts/simple-line-icons/products_styles.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/core/colors/palette-gradient.css')}}">
