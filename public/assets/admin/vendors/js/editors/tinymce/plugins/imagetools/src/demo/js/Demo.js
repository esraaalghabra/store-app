...
define("tinymce/imagetoolsplugin/Demo", [
	...
	return function() {
		var imgSrc = '../../../../../../../tests/manual/products/dogleft.jpg';

		$(
			'<textarea class="tinymce">' +
				'<p>' +
					'<products src="' + imgSrc + '" width="160" height="100">' +
					'<products src="' + imgSrc + '" style="width: 160px; height: 100px">' +
					'<products src="' + imgSrc + '" style="width: 20%">' +
					'<products src="' + imgSrc + '">' +
					'<products src="http://moxiecode.cachefly.net/tinymce/v9/images/logo.png">' +
				'</p>' +
			'</textarea>'
		).appendTo('#ephox-ui');
